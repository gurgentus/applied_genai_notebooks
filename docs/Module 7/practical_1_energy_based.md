...
!!! note "Related Resources"
    - [View on GitHub](https://github.com/gurgentus/applied_genai_notebooks/blob/main/notebooks/Module_7_Practical_1_EnergyBasedMethods.py) - See the source code
    - [Run Locally](../running_locally.md) - Instructions for running with GPU acceleration support

<iframe src="https://appliedgenainotebooks-production.up.railway.app/?file=Module_7_Practical_1_EnergyBasedMethods.py"
